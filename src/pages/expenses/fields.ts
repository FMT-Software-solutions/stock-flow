...
export const expenseExportFields: ExportField[] = [
  ...
  { id: 'categoryName', label: 'Category', accessorFn: (row: any) => row.original.categoryName || 'Uncategorized' },
  { id: 'typeName', label: 'Type', accessorFn: (row: any) => row.original.typeName || 'Unknown Type' },
